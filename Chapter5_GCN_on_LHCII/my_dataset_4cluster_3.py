...
class My_dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if index <1000:
            #means it's the first copy.
            
            data = torch.load(self.dir_path + 'data_as_graphs_22062021_7_1_1' + str(index) + '.pt')
            ...
            index -= 1000
            data = torch.load(self.dir_path + 'data_as_graphs_22062021_7_2_1' + str(index) + '.pt')
            ...
            index -= 2000
            data = torch.load(self.dir_path + 'data_as_graphs_22062021_7_3_1' + str(index) + '.pt')
